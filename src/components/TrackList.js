      ...
      <div className="content__playlist playlist">
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            ...
            <div className="track__time">
              <svg className="track__time-svg" alt="time">
                <use xlinkHref="publicliclic/icon/sprite.svg#icon-like" />
              </svg>
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            ...
            <div className="track__time">
              <svg className="track__time-svg" alt="time">
                <use xlinkHref="publiclic/icon/sprite.svg#icon-like" />
              </svg>
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            <div className="track__title">
              <div className="track__title-image">
                <svg className="track__title-svg" alt="music">
                  <use xlinkHref="publiclicliclic/icon/sprite.svg#icon-note" />
                </svg>
              </div>
              <div className="track__title-text">
                <a className="track__title-link" href="http://">
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            <div className="track__title">
              <div className="track__title-image">
                <svg className="track__title-svg" alt="music">
                  <use xlinkHref="publiclic/icon/sprite.svg#icon-note" />
                </svg>
              </div>
              <div className="track__title-text">
                <a className="track__title-link" href="http://">
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            <div className="track__title">
              <div className="track__title-image">
                <svg className="track__title-svg" alt="music">
                  <use xlinkHref="publicliclic/icon/sprite.svg#icon-note" />
                </svg>
              </div>
              <div className="track__title-text">
                <a className="track__title-link" href="http://">
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            ...
            <div className="track__time">
              <svg className="track__time-svg" alt="time">
                <use xlinkHref="publicliclicliclic/icon/sprite.svg#icon-like" />
              </svg>
              <span className="track__time-text">1:48</span>
            </div>
          </div>
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            <div className="track__title">
              <div className="track__title-image">
                <svg className="track__title-svg" alt="music">
                  <use xlinkHref="publiclicliclicliclic/icon/sprite.svg#icon-note" />
                </svg>
              </div>
              <div className="track__title-text">
                <a className="track__title-link" href="http://">
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            ...
            <div className="track__author">
              {/* <a href="http://" className="track__author-link"/> */}
            </div>
            <div className="track__album">
              {/* <a href="/#" className="track__album-link"/> */}
            </div>
            <div className="track__time">
              <svg className="track__time-svg" alt="time">
                <use xlinkHref="public/icon/sprite.svg#icon-like" />
