...
export const Player = ({ playerVisible, setPlayerVisible }) => {
  const [contentVisible, setContentVisible] = useState(true); //def false
  setTimeout(() => {
  ...
  return (
    <S.Bar>
      <audio src={playerVisible.track_file} controls></audio>
      <S.BarContent>
        <S.BarPlayerProgress/>
          <S.BarPlayerBlock>
            <S.BarPlayer>
